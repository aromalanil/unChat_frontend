  ...
  return (
    <div className="social-share">
      ...
      <div className="share-btns">
        <a target="_blank" rel="noopener noreferrer" href={`https://api.whatsapp.com/send?text=${text} ${shareUrl}`}>
          <i className="fab fa-whatsapp"></i>
        </a>
        <a target="_blank" rel="noopener noreferrer" href={`https://www.facebook.com/sharer/sharer.php?u=${shareUrl}`}>
          <i className="fab fa-facebook"></i>
        </a>
        <a target="_blank" rel="noopener noreferrer" href={`https://telegram.me/share/url?url=${shareUrl}&text=${text}`}>
          <i className="fab fa-telegram"></i>
        </a>
        <a target="_blank" rel="noopener noreferrer" href={`http://twitter.com/share?text=@${text}&url=${shareUrl}/&hashtags=anonymous,messaging,cool_website`}>
